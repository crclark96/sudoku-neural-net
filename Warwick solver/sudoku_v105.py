...
#this is where I added functionality to output solutions, take command line arguments, etc.
    parser = argparse.ArgumentParser(description='Solve some sudoku. ')
    parser.add_argument('file', metavar='F', type=str, help='filename containing a list of sudoku puzzles to be solved')

    args = parser.parse_args()
    test_file = args.file
    #test_file = raw_input("Filename: ")
    new_filename = test_file+ ".solution"
